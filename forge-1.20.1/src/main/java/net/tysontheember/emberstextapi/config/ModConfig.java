...
public class ModConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue IMMERSIVE_MESSAGES_ENABLED;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> DISABLED_EFFECTS;

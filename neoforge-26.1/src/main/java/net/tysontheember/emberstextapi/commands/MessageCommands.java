            ...
            Component.literal("Documentation & Examples: ")
                ...
                .append(Component.literal("tysontheember.dev")
                    .withStyle(Style.EMPTY
                        .withColor(0x55AAFF)
                        .withUnderlined(true)
                        .withClickEvent(new ClickEvent.OpenUrl(java.net.URI.create("https://tysontheember.dev"))))),
            false);
            ...
            Component.literal("Join the Discord: ")
                ...
                .append(Component.literal("discord.gg/vY77wF48GV")
                    .withStyle(Style.EMPTY
                        .withColor(0x7289DA)
                        .withUnderlined(true)
                        .withClickEvent(new ClickEvent.OpenUrl(java.net.URI.create("https://discord.gg/vY77wF48GV"))))),
            false);
        ...
        switch (id) {
            ...
            case 10 -> {
                Component norse = Component.literal("\u16A0\u16A2\u16A6\u16A8\u16AB\u16B2")
                        .withStyle(s -> s.withFont(new net.minecraft.network.chat.FontDescription.Resource(Identifier.fromNamespaceAndPath(EmbersTextAPI.MODID, "norse"))));
            ...
            case 13 -> {
                ...
                spans.add(new TextSpan("\u16A0\u16A2\u16A6 ").font(Identifier.fromNamespaceAndPath(EmbersTextAPI.MODID, "norse")));

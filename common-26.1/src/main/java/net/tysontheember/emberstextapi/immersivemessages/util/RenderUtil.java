...
public final class RenderUtil {
    ...
    public static void fillGradient(GuiGraphicsExtractor graphics, int x1, int y1, int x2, int y2, int top, int bottom) {
    ...
    private static void fillHorizontalGradient(GuiGraphicsExtractor graphics, int x1, int y1, int x2, int y2, int[] gradient) {
        int w = x2 - x1;
        for (int i = 0; i < w; i++) {

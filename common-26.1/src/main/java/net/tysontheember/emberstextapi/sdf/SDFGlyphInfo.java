...
public class SDFGlyphInfo implements UnbakedGlyph {

    private final GlyphInfo glyphInfoDelegate;
    ...
    public SDFGlyphInfo(float advance, FT_Face ftFace,
        ...
        this.glyphInfoDelegate = new GlyphInfo() {
            @Override
    ...
    public BakedGlyph bake(UnbakedGlyph.Stitcher stitcher) {
        ...
        if (preBaked != null) {
            ...
            return stitcher.stitch(glyphInfoDelegate, new SDFSheetGlyphInfo(
                    preBaked.msdfData(), preBaked.texW(), preBaked.texH(),
                    preBaked.bearingLeft(), preBaked.bearingTop(), preBaked.oversample()
            ));
        }
        ...
        LOGGER.debug("Bake '{}': MSDF tex={}x{} oversample={} bearingLeft={} bearingTop={} up={}",
                (char) codepoint, texW, texH, oversample, bearingLeft, bearingTop, 7.0f - bearingTop);

...
public final class SDFGlyphProviderDefinition {
    ...
    public static GlyphProvider load(JsonObject json, ResourceManager resourceManager) {
        ...
        try {
            ...
            Identifier fontFile = Identifier.parse(fileStr);
            ...
            Identifier fontResourceLoc = Identifier.fromNamespaceAndPath(
    ...
    @Nullable
    private static ByteBuffer loadFontData(ResourceManager resourceManager, Identifier location) {
        try {

    ...
    public static void register() {
        ServerMessageEvents.ALLOW_CHAT_MESSAGE.register((message, sender, params) -> {
            ...
            if (!ConfigHelper.getInstance().isPlayerAllowedMarkup(sender.getUUID())) {
                ...
                sender.level().getServer().getPlayerList().broadcastSystemMessage(strippedComponent, false);
                return false;
            }
            ...
            if (!disallowed.isEmpty()) {
                ...
                if (!filtered.equals(content)) {
                    ...
                    sender.level().getServer().getPlayerList().broadcastSystemMessage(filteredComponent, false);
                    return false;
                }
            }
